...
class ObjectTreeView {
	...
	buildTree() {
		...
		for(var template_name in this.context.server_env.templates) {
			if(!Object.prototype.hasOwnProperty.call(this.context.server_env.templates,template_name))
				continue;
...
function node_comparator(a, b) {
	const secondpart = a.name === b.name ? 0 : -1;
	return a.name > b.name ? 1 : secondpart;
}
